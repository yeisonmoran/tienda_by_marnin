<?php
// Protección de sesión: todas las páginas que incluyan este header quedan protegidas
session_start();
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-primary ml-1" style="font-size:.65rem;"><?= htmlspecialchars($_SESSION['nombre_rol']) ?></span>
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
        <div class="image">
          <div style="width:35px;height:35px;border-radius:50%;background:linear-gradient(135deg,#667eea,#764ba2);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:1rem;">
            <?= strtoupper(substr($_SESSION['nombre'], 0, 1)) ?>
          </div>
        </div>
        <div class="info ml-2">
          <a href="#" class="d-block text-white" style="font-size:.9rem;"><?= htmlspecialchars($_SESSION['nombre']) ?></a>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/tienda_by_marnin/modulos/productos/listar.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i><p>Ver Productos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/tienda_by_marnin/modulos/productos/crear.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i><p>Nuevo Producto</p>
                </a>
              </li>
            </ul>
          </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/tienda_by_marnin/modulos/categorias/crear.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i><p>Nueva Categoría</p>
                </a>
              </li>
            </ul>
          </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/tienda_by_marnin/modulos/ventas/listar.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i><p>Historial de Ventas</p>
                </a>
              </li>
              <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/tienda_by_marnin/modulos/clientes/listar.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i><p>Ver Clientes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/tienda_by_marnin/modulos/clientes/registrar_client.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i><p>Nuevo Cliente</p>
                </a>
              </li>
            </ul>
          </li>
